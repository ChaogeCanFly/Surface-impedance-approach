...
% Incident_Inten_tot = 0.5*real(P_t.*conj(v_t));   
Incident_Inten_tot = 0.5*real(P0*exp(-1i*k0*sin(th_ind)*xn).*conj(P0/Z0*(exp(-1i*k0*sin(th_ind)*xn) * cos(th_ind))))
            ...
            case 1
                switch k2
                    case 1
                        grid on;       %   grid minor;
                        hold on;
                        PP = plot(xx,abs(Pr_m),'-o','color','b','LineWidth',2,'MarkerFaceColor','r' );
                        hold on;
                        PP2 = plot(xx,abs(Pr_m),'d', 'MarkerIndices',marker_xx, 'MarkerFaceColor','g', 'MarkerSize',10);
                        xlabel('Harmonics $n$','Interpreter', 'LaTeX','FontSize',fontsz);
                        ylabel('Amplitude ($|A_n|/P_{\rm in}$)', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        xlim([-4 4]);  xticks(-10:2:10); yticks(-10:0.5:10);  %ylim([-90 90]); 
                    ...
                    case 2
                        grid on;         grid minor;
                        hold on;        
                        PP = plot(xx,theta_r*180/pi,'-o','color','b','LineWidth',2,'MarkerFaceColor','r' );
                        hold on;
                        PP2 = plot(xx,theta_r*180/pi,'d', 'MarkerIndices',marker_xx, 'MarkerFaceColor','g', 'MarkerSize',7);
                        xlabel('Harmonics $n$','Interpreter', 'LaTeX','FontSize',fontsz);
                        ylabel('Reflected angle $\theta_{\rm r}$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        xlim([-4 4]); ylim([-90 90]); xticks(-10:2:10); yticks(-90:15:90); %colorbar('Ticks',[-90:30:90]);    caxis([-90 90]);
                        legend('');   h = legend;   h.Visible = 'off'; 
                        set(legend,'Interpreter','latex','edgecolor','none','Location','northwest','FontSize',fontsz);
                        set(gca,'position',[(1-nw)/n2/2 + (k2-1)/n2+0.03, (1-nh)/n1/2 + 1-k1/n1,  nw/n2, nh/n1]*beishu0);
                    case 3
                        plot(xn/Dxn,real(vpa(Zs,4))/Z0,'-o','color','k','LineWidth',2,'MarkerFaceColor','k')
                        xlabel('$x/D$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        ylabel('${\rm Re}(Z_s/Z0)$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        ylim([0 100000])
                        legend('');   h = legend;   h.Visible = 'off';
                        set(legend,'Interpreter','latex','edgecolor','none','Location','northwest','FontSize',fontsz);
                        grid on
            ...
            case 2
                switch k2
                    case 1
                        ...
                        xlabel('$x/D$', 'Interpreter','LaTeX','FontSize',fontsz);
                        ylabel('${\rm Imag}(Z_s/Z0)$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        ylim([-1 1]*0.0001);  yticks(-1e-4:1e-4/2:1e-4);
                        legend('');   h = legend;   h.Visible = 'off';
                        set(legend,'Interpreter','latex','edgecolor','none','Location','northwest','FontSize',fontsz);
                        grid on
                        set(gca,'position',[(1-nw)/n2/2 + (k2-1)/n2+0.03, (1-nh)/n1/2 + 1-k1/n1,  nw/n2, nh/n1]*beishu0);
                    case 2
                        ...
                        xlabel('$x/D$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                        ylabel('$I_y$/$I_{\mathrm{i}}$', 'Interpreter', 'LaTeX','FontSize',fontsz);
                                 ylim([-100e-4 100e-4]);  yticks(-100e-4:100e-4/2:100e-4); %colorbar('Ticks',[-90:30:90]);    caxis([-90 90]);
                        %                         ylabel('Ticks',[-4.46 -4.44]);
%                         colorbar('Ticks',[-10:2:10]);               caxis([-4.46 -4.44]);
                        legend('at $y=0$','at $y=d_z$');   h = legend;  % h.Visible = 'off';
                        set(legend,'Interpreter','latex','edgecolor','none','Location','northoutside','FontSize',fontsz);
...
xlabel('Harmonics $n$','Interpreter', 'LaTeX','FontSize',fontsz);
ylabel('Amplitude ($|A_n|/P_{\rm in}$)', 'Interpreter', 'LaTeX','FontSize',fontsz);
xlim([-3 3]);  xticks(-10:1:10); yticks(-10:0.2:10);  ylim([-0.0005 1]);
legend('');   h = legend;   h.Visible = 'off';
set(legend,'Interpreter','latex','edgecolor','none','Location','northwest','FontSize',fontsz);
%
yyaxis right;
...
%                         xlabel('Harmonics $n$','Interpreter', 'LaTeX','FontSize',fontsz);
ylabel('Reflected angle $\theta_{\rm r}$', 'Interpreter', 'LaTeX','FontSize',fontsz);
xlim([-3 3]); ylim([-90 90]); xticks(-10:1:10); yticks(-90:15:90); %colorbar('Ticks',[-90:30:90]);    caxis([-90 90]);
legend('');   h = legend;   h.Visible = 'off';
set(legend,'Interpreter','latex','edgecolor','none','Location','northwest','FontSize',fontsz);
set(gca,'position',[0.513*0.5    0.5838    0.2866*0.9    0.3412]*beishu0);
hold off

print(gcf, '-djpeg', '-r300', './Fig1_validation20211219.jpg');
print(gcf, '-depsc2', '-r300', './Fig1_validation20211219.eps');
